...
const PostHeader = ({
  ...
  return (
    <div className="flex items-center justify-between space-x-2 mb-1">
        <Link href={`/profile/${username}`} className="flex items-center text-sm xs:text-[15px] sm:text-base font-semibold hover:underline space-x-2 dark:text-twitterTextDarkmode post-userLink">
